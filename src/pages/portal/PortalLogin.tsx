...
export function PortalLogin() {
  ...
  if (!settings) {
    return (
      <div className="force-dark min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex flex-col items-center justify-center p-4" dir={dir}>
